...
import { Check, ChevronRight, Menu, X, Moon, Sun, ArrowRight, Zap, Shield, Users, BarChart, Layers, Star } from 'lucide-react'
      ...
      <ThemeProvider defaultTheme="system" storageKey="vite-ui-theme">
        <div className="flex min-h-[100dvh] flex-col">
          ...
          >
            <div className=" flex h-16 items-center">
              <div className="flex items-center gap-2 font-bold">
                ...
                <a href="#"><span>SaaSify</span></a>
              </div>
              <nav className="hidden md:flex gap-8 mx-auto justify-center">
                <a
                  href="#features"
          ...
          <main className="flex-1">
            ...
            <section className="w-full py-12 md:py-10 overflow-hidden">
          ...
          <footer className="w-full border-t bg-background/95 backdrop-blur-sm">
            <div className=" flex flex-col gap-8 px-4 py-10 md:px-6 lg:py-16">
              <div className="grid gap-8 sm:grid-cols-2 md:grid-cols-4">
                <div className="space-y-4">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Streamline your workflow with our all-in-one SaaS platform. Boost productivity and scale your
                    business.
                  </p>
